    ...
    <main style="flex:5; height:100%">
        ...
        <div class="popup-content">
            ...
            <div style="padding: 30px 0px">
                ...
                <form method="POST"  action="/admin{{$address->path()}}">
                    @csrf
                    @method('PATCH')
                    ...
                    <x-form.field>
                        <select class="form-group row" id="users" name="user_id"class="form-control" style="width:70%;font-size:large ">
                            <option value="{{ $address->user->id }}">id[{{$address->user->id}}] {{ $address->user->name }} {{ $address->user->surname }} </option>
                ...
                <div class="form_footer_btns">
                    <a href="/admin/addresses"  style="text-decoration:none;font-weight:normal;" id="default_button_form">Atcelt</a>
